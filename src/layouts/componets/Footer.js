            ...
            <div className="container-fluid pt-5 bg-footer">
                <div className="container mb-4">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div className="footer-list-div">
                                <ul>
                                    <li><a href="#">Chikken KFC</a></li>
                                    <li><a href="#">Donnut J.CO</a></li>
                                    <li><a href="#">Coffee Starbucks</a></li>
                                    <li><a href="#">Pizza PH</a></li>
                                    <li><a href="#">Burger Mc'D</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="footer-list-div">
                                ...
                                <ul>
                                    ...
                                    <li className="pb-3">
                                        ...
                                        <span>bookfooddelivery@gmail.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2020 Book & Food. All Rights Reserved. Powered By <span style={{ color: "#eb6825", fontWeight: 700 }}>Treido Ristivan</span></p>
                    </div>
                </div>
            </div>
        );
